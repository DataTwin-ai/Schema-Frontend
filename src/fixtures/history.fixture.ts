...
export const sampleHistoryRecords: HistoryRecord[] = [
  {
    id: 'hist-001',
    name: 'Supplier Advance Allocation & Net Payable Schedule',
    domain: 'Accounts Payable (AP)',
    description: 'Automated calculation of supplier advance payments, FIFO matching against purchase order invoices, and remaining advance tracking.',
    status: 'Completed',
    version: 'v1.2',
    classCount: 7,
    componentCount: 25,
  ...
  },
  {
    ...
    workflowState: {
      ...
      classes: sampleSchemaClasses.slice(0, 5),
      schema: sampleSchemaModel,
      additionalInformation: [],
      generationStatus: 'completed',
      currentProgressSteps: [],
